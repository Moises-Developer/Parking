...
<nav class="navbar navbar-light">
    <div class="container-fluid">
        ...
        <a class="navbar-brand" href="#">ESTADISTICA DE VEHICULOS - DASHBOARD</a>
...
<div class="dashboard">
    <div class="container getThr">
        <div class="styleblock">
            ...
            <ul class="unlist">
                <li><a href="{{ url('estadisticas/carros') }}">Estadistica de vehiculos.</a></li>
        ...
        <div>
            ...
            <canvas id="myChartTwo" width="400" height="400" style="background: black"></canvas>
