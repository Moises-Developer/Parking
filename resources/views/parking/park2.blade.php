      ...
      <div class="offcanvas-body">
        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3 ds">
          <li class="nav-item fd nvCuad">
            <a class="nav-link nvlet rg" aria-current="page" href="/dashboard/1">Piso 1</a>
          </li>
          <li class="nav-item fd nvPos">
            <a class="nav-link active nvlet" href="/dashboard/2">Piso 2</a>
          </li>
          <li class="nav-item fd nvCuad">
...
<div class="dashboard">
    <div class="container margin-top">
        <div class="container mapa1">
            <div class="liberado identificador">11</div>
            <div class="liberado identificador">12</div>
            <div class="liberado identificador">13</div>
            <div class="liberado identificador">14</div>
            <div class="liberado identificador">15</div>
        </div>
        ...
        <div class="container mapa1">
            <div class="liberado identificador">16</div>
            <div class="liberado identificador">17</div>
            <div class="liberado identificador">18</div>
            <div class="liberado identificador">19</div>
            <div class="liberado identificador">20</div>
        </div>
    </div>
